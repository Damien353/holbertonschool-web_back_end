...
This module defines a function that returns the length of each element in a list.
"""
...
def element_length(lst: Iterable[Sequence]) -> List[Tuple[Sequence, int]]:
    ...
    Returns:
        List[Tuple[Sequence, int]]: A list of tuples with the sequence and its length
    """
